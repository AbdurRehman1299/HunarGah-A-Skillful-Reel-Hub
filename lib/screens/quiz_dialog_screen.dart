...
class _QuizDialogState extends State<QuizDialog> {
    ...
    return Dialog(
      ...
      child: Column(
        ...
        children: [
          ...
          // -- Main Quiz Card --
          quizCard(themeColor, context),
        ],
      ),
    );
  }

  Container quizCard(Color themeColor, BuildContext context) {
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          timerAndQuestionCount(themeColor),
          ...
          _buildOption('C', 'Screwdriver', Icons.settings_input_component),
          ...
          // -- Footer (Points & Skip) --
          pointsAndSkipButton(context),
        ],
      ),
    );
  }

  Row pointsAndSkipButton(BuildContext context) {
    return Row(
  ...
  Container tipBox() {
    return Container(
      ...
      child: Row(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Icon(Icons.help_outline, size: 18, color: Colors.grey[800]),
  ...
  Container quizLevel(Color themeColor) {
    return Container(
  ...
  Row progressBar(Color themeColor) {
    return Row(
      children: [
        Expanded(flex: 4, child: Container(height: 4, color: themeColor)),
        Expanded(
          flex: 6,
          child: Container(
            height: 4,
  ...
  Row timerAndQuestionCount(Color themeColor) {
    return Row(
      mainAxisAlignment: MainAxisAlignment.spaceBetween,
      children: [
        Row(
