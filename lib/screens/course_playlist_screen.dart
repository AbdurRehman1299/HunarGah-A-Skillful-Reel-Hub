...
class _CoursePlaylistScreenState extends State<CoursePlaylistScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      bottomNavigationBar: actionButtons(themeColor),
      body: SingleChildScrollView(
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            // Video Player
            videoPlayer(themeColor),
  ...
  Padding instructorInfo(Color themeColor) {
    return Padding(
      padding: const EdgeInsets.all(16.0),
      child: Row(
        children: [
  ...
  OutlinedButton subscribeButton(Color themeColor) {
  ...
  Container videoPlayer(Color themeColor) {
    return Container(
      height: 220,
      ...
      child: Stack(
        children: [
          ...
          // Center Play Button
          playButton(themeColor),
          // Bottom Progress Area
          videoProgress(themeColor),
        ],
      ),
    );
  }

  Positioned videoProgress(Color themeColor) {
    return Positioned(
      bottom: 0,
      left: 0,
      right: 0,
  ...
  Center playButton(Color themeColor) {
    return Center(
      child: Container(
        width: 50,
        height: 50,
  ...
  Container actionButtons(Color themeColor) {
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          resumeLessonButton(themeColor),
        ],
      ),
    );
  }

  SizedBox resumeLessonButton(Color themeColor) {
    return SizedBox(
      width: 160,
      height: 44,
      ...
      child: Container(
        ...
        child: Row(
          ...
          children: [
            ...
            videoTitleAndStatus(title, titleColor, statusText, statusColor),

            videoTime(time, state),
          ],
        ),
      ),
    );
  ...
  Column videoTime(String time, LessonState state) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.end,
      children: [
        Row(
